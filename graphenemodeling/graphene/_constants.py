...
A = 3*(3**(1/2))*(self.a**2) / 2      # (m^2), area of unit cell of graphene
g0 = 2.8*eVtoJ                         # (J), Interatom hopping potential
g0prime = 0 * self.g0                 # particle hole asymmetry           
vF = 3*self.a*self.g0/(2*sc.hbar)         # Fermi velocity

W = 4.6 * eVtoJ                        # Work function of graphene. See 10.1038/nphys1022

K = (2*sc.pi/(3*self.a)) + 1j*(2*sc.pi/(3*(3**(1/2))*self.a)) # The magnitude of the K point vector
